      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <ul className="mt-4 space-y-3 text-sm text-brand-muted">
            <li className="flex gap-3"><span className="text-brand">✓</span><span>Make sure all fields are accurate and complete</span></li>
            <li className="flex gap-3"><span className="text-brand">✓</span><span>Upload a clear plot, land, shop or property image</span></li>
            <li className="flex gap-3"><span className="text-brand">✓</span><span>Your listing will be reviewed within 24 hours</span></li>
          </ul>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-brand">Listing gets more visibility when</p>
          <ul className="mt-4 space-y-3 text-sm text-brand-muted">
            <li className="flex gap-3"><span className="text-brand-accent">⭐</span><span>Your property details are complete and accurate</span></li>
            <li className="flex gap-3"><span className="text-brand-accent">⭐</span><span>You respond quickly to buyer inquiries</span></li>
            <li className="flex gap-3"><span className="text-brand-accent">⭐</span><span>Your property is in high-demand locations</span></li>
          </ul>
        </div>
      </section>
